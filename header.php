...
<head>
    ...
    ?>
    <title><?php if (is_home()) {echo "FineReport-最強大動態報表與BI商業智慧軟體，高效、靈活的資料視覺化";}
        ...
        {echo "页面未找到!";}else {wp_title('',true);echo " | FineReport-最強大動態報表與BI商業智慧軟體";} ?></title>
    <?php if ( is_home() ) { ?>
                    ...
                    <ul class="dropdown-menu megamenu row" style="opacity: 1; display: none;">
                        <li class="col-xs-12">
                            <ul>
                                ...
                                <li class="divider"></li>
                                <li><a href="/tw/online-course" target="_blank">新手入門</a></li>
                                <li><a href="/tw/video/learning-pathway" target="_blank">學習計畫</a></li>
                                <li><a href="/tw/video" target="_blank">課程教學</a></li>
                                <li><a href="https://fanruanhelp.zendesk.com/hc/zh-tw" target="_blank">幫助文檔</a></li>
