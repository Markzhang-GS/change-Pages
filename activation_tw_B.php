...
<?php
    /**
     * Template name:new_activation_tw_B page
     * By Cobb
     * 2020.09.23
     */
    ?>
...
<head>
    ...
    <script>
        ...
        j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-P9PW5ZX');
    </script>
...
<noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P9PW5ZX" height="0" width="0" style="display:none;visibility:hidden"></iframe>
</noscript>
...
<!--                        <li class="Activation_Step  ">3</li>-->
                ...
                <div class="Activation_BOx_Wrapper_Content_Right Activation_BOx_Wrapper_Content_Left">                         
                    <form action="" method="post" id="form1" class="Activation_form" onsubmit="return false">
                        <h2 style="text-align:center;">登录/註冊</h2>
...
<!--                        <div id="box"></div>-->
                       ...
                                              
                        <button type="submit"  name="next" class="next1" id="next1" style="margin-top:30px;"
                                onclick="ga('send','pageview','/virtual/active-step1');">開始免費試用
                        </button>
                    </form>
                ...
                <div class="Activation_BOx_Wrapper_Content_Right Activation_BOx_Wrapper_Content_Left">
                    ...
                    <form action="" method="post" id="form2" class="Activation_form" onsubmit="return false"
                        ...
                        <div class="form-control">
                            ...
                            <input
                                style="font-size: 13px;width: 45%;height: 42px;background-color: #4f8df9;color:#fff;display: inline-block;"
                                onclick="getVerificationCode()" type="button" value="獲取驗證碼" name="btn" id="btn"
                                class="button">
                            <i class="fas fa-check-circle"></i>
                            <i class="fas fa-exclamation-circle"></i>
                        </div>
                        <a id="next2" class="backup"
                           style="font-size: 14px;padding-right: 2.5%;margin-top: 15px;font-weight: 600;display: none; color: #2655B4"
                           onclick="backup()"><u>收不到驗證碼？ </u> 输入 0830</a>   
    ...
    <div class="feedbackBox" id="feedback">
        ...
        <div class="feedbackBoxContent">
            ...
            <form action="https://www.finereport.com/en/wp-content/themes/Newweb/feedback.php" onsubmit="return false">
                ...
                <textarea name="" id="feedbackContent" cols="30" rows="6" placeholder="Type here"
                          class="user"></textarea>
