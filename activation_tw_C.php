            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.code != '000000'){
                        ...
                        btn.css("background-color","#a2a2a2");
                        ...
                        var hander = setInterval(function() {
                            if (time <= 0) {
                                ...
                                jQuery(".backup").show();
                                // document.getElementById("btn").style.background = "#009ACD";
                                btn.css("background-color","#4f8df9");
    ...
       <div class="Activation_Box_layout Activation_Box">
                ...
                <div class="Activation_BOx_Wrapper_Content_Right Activation_BOx_Wrapper_Content_Left">
                    ...
                                                         <form action="" method="post" id="form1" class="Activation_form" onsubmit="return false">
                        ...
                        <div class="form-control">
                            ...
                            <input style="font-size: 13px;width: 45%;height: 42px;background-color: #4f8df9;color:#fff;display: inline-block;" onclick = "getVerificationCode()" type="button" value="獲取驗證碼" name="btn" id="btn" class="button">
                            <i class="fas fa-check-circle"></i>
                            <i class="fas fa-exclamation-circle"></i>
                        </div>
        ...
        <div class="Activation_Box_Wrapper">
            <div class="Activation_BOx_Wrapper_Content">
                ...
                <div class="Activation_BOx_Wrapper_Content_Right Activation_BOx_Wrapper_Content_Left">
                    <form action="https://www.finereport.com/tw/new_success" method="post" id="form3" class="Activation_form"  style="padding-left: 15px;" >
                        <div id="fb-root"></div>
                        ...
                        <div style="margin-top: 50px; text-align: center;">
                            <h3 style="margin-bottom: 10px; font-size:25px;"><a id="FBTW" href="https://www.facebook.com/twfinereport/" target="_blank" style="text-decoration: none">加入帆軟臉書/Line粉絲團</a> 獲取</h3>
                                                       <p style="font-size: 14px; color: grey;font-weight:bold;" id="FB33" >最新課程資訊,海量學習資料,豐富企業實例</p>
                            <div class="fb" style="float:left; width: 50%;">
                                <img src="https://www.finereport.com/tw/wp-content/themes/BusinessNews/images/fbqrcode.jpg" alt="" style="width: 100%;">
                            ...
                            <div class="line">
                                <img src="https://www.finereport.com/tw/wp-content/themes/BusinessNews/images/Line.png" alt="" style="width: 50%;"><br>
                                <a href="https://lin.ee/K8bh9iV" target="_blank"><img src="https://scdn.line-apps.com/n/line_add_friends/btn/zh-Hant.png" alt="加入好友" height="30" border="0"></a>
                                <p style="font-size: 12px;"><a href="https://lin.ee/K8bh9iV" target="_blank" style="color: #7d8189;text-decoration: none;" id="lineTW">回覆簡報送最新10.0產品簡報</a></p>
                            </div>
                            <input  type="text" style="display: none;" id="KEY" name="KEY" value="<?php
                            echo $_product_key
                            ?>">

                                                   <button id="Submit_FB" type="submit"  name="next" class="next3"   style="margin-top: 20px;" onclick="ga('send','pageview','/virtual/active-step3');"  >完成激活</button>
...
<script>
    ...
    $("#btn").mouseout(function(){
        $(this).css("background-color","#4f8df9");
    })

    $("#next1,#next2").mouseenter(function(){
        $(this).css("cursor","pointer");
    })
    ...
    document.getElementById('lineTW').addEventListener('click',function(){
...
<script  src="activation_tw_C.js"></script>
